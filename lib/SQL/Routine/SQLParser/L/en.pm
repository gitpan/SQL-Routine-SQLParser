...
The SQL::Routine::SQLParser::L::en Perl 5 module contains localization data
for SQL::Routine::SQLParser.  It is designed to be interpreted by
Locale::KeyedText.  Besides localizing generic error messages that
SQL::Routine::SQLParser produces itself, this file also provides a
...
on CPAN, or on L<SQL::Routine::SQLParser>, which is in the current
